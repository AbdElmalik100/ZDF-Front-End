                    ...
                    <div className="container px-4 flex items-stretch gap-5 max-md:flex-col">
                        <aside className='w-1/3 max-md:w-full rounded-lg shadow-md bg-white p-4 border flex flex-col gap-5'>
                            ...
                            <ul className="links flex flex-col gap-2">
                                <li>
                                    <Link href={`/${user._id}/subscriptions`} className={`flex items-center gap-2 p-2 px-3 rounded-lg transition-all ease-in-out hover:bg-neutral-50 ${pathname.includes("subscriptions") ? 'text-white bg-sky-400 hover:bg-sky-400' : ''}`}>
                            ...
                            <button className='logout flex p-2 px-3 rounded-lg text-rose-700 transition-all ease-in-out hover:bg-rose-50 w-full items-center gap-2 mt-auto'
                                onClick={userLogout}>
